...
<loading-bar if={loading}></loading-bar>  
	<section class="container is-fluid" show={fee_plan_view =='show_fee_plan'}>
        ...
        <button class="button is-primary has-text-weight-bold" onclick="window.print()" title="Print">
                <span class="icon">
				...
				<tr each={s, i in feePlans}>
					...
					<td>{ s.standard}</td>
		          	<td class="has-text-right" >
            			<div class="inline-flex rounded border border-grey overflow-hidden  no-print" hide={s.confirmDelete}>
                      ...
                      <span><a class="button is-small is-rounded is-success" onclick={mapHead.bind(this, s.fee_plan_id)}>Map Fee Head</a></span>
              			...
              			<div class="table-buttons  no-print" if={s.confirmDelete}>
