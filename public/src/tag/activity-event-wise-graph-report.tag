<activity-event-wise-graph-report>
    ...
    <h2 class="title has-text-centered is-size-5" style="color: #ff3860;">Category Wise Activity Graph</h2>
	...
	<div class="columns is-centered no-print">
		<table class="table is-striped is-hoverable is-bordered is-fullwidth" show={report_view =='show_table'}>
			<thead>
				<tr>
				    <th>Category</th>
				    <th class="has-text-right">Total</th>
