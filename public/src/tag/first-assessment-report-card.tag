		  	...
		  	<table class="table is-fullwidth is-narrow divider-subject bottom-border">
				...
				<tbody>
					<tr each={m in r.marks} class="{m.show_in} {m.subject_group_class}">
					    ...
					    <td class="has-text-centered lr-table-border {m.class}" style="vertical-align: middle;" rowspan="{m.subject_group_count}" hide={m.hide_avg_td}>{m.first_avg_marks}</td>
		    			...
		    			<table class="table is-fullwidth is-narrow is-bordered">
		    				...
		    				<thead>
								<tr>
									...
									<th style="width:250px" class="has-text-centered">Marks (First Term)</th>
								</tr>
							</thead>
							<tbody>
								<tr>
