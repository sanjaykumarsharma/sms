<courses>
	<section class="container is-fluid">
		<h2 class="title" style="color: #ff3860;">Courses</h2>
		...
		<div class="box">
			<div class="columns">
				<div class="column is-one-quarter">
					...
					<input type="text" ref="addCourseInput" class="input">
				</div>
				<div class="column is-half">
					<label class="label" for="course_full_name">Full name</label>
					<input class="input" type="text" ref="addCourseFullNameInput">
				</div>
		...
		<table class="table is-fullwidth is-striped is-hoverable">
			...
			<tbody>
				<tr each={c, i in courseDataItems}>
					<td>{c.course}</td>
					<td>{c.course_full_name}</td>
